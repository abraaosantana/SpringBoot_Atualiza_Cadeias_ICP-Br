...
public class CacertUtil {
	...
	private static final String CACERT = "C:\\Users\\AbraaoSantana\\Documents\\Cacerts";
    private static final String CERTS_DESTINO = "C:\\Repositorio\\Certs";
	private static final String KEYTOOL_HOME = "C:\\Program Files\\Java\\jre1.8.0_181" + File.separatorChar + "bin";
	...
	private static void gerarCacert(List<String> listaEnderecos) {
		...
		try {
			...
			if(!arquivoCacert.isFile()) {
				File dir = new File("C:\\Program Files\\Java\\jre1.8.0_181" + File.separatorChar + "lib" + File.separatorChar + "security");
            ...
            aliasList.forEach(aliasName -> {
                String arquivo = CmdProcessRunUtil.runProcessKeytool(KEYTOOL_HOME, aliasName, CACERT, CERTS_DESTINO, keyPass);
	...
	private static List<String> get(String host, KeyStore ks) {
		try {
